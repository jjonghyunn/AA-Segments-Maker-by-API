# extract_data_v3.4.py
# 2026-06-04  Jonghyun Park w/ Claude
# v3.4 (2026-06-04): name_keywords 패널-우선 해석 + SKIP_PANEL_SEGMENT_KEYWORDS + EXTRA↔SKIP 충돌검사
"""
...
def _resolve_extra_segment(spec: dict, headers: dict, gcid: str, ts_str: str, panels: list[dict] | None = None) -> str | None:
    ...
    #   패널 내 1건 → 그 세그 바로 사용 / 2건+ → 중단 / 0건 → 회사 전체 검색 fallback
...
def main() -> int:
    ...
    print(f"[{ts}] extract_data_v3.4.py")
