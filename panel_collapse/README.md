...
로컬 운영 사본엔 실제 PROJECT_ID / AUTH 경로를 박아 쓰지만, **이 repo 사본은 placeholder**. generic 변경 (룰/기능) 은 repo 사본에도 동기화. 단순 운영값 (PROJECT_ID) 변경은 repo 안 올림.
...
```powershell
cd "C:\Users\YOUR_USER\OneDrive - YOUR_COMPANY\your_folder\your_workspace\AA_segment_maker\panel_collapse"
...
```
[2026-05-13 18:45:12] GET project YOUR_PROJECT_ID ...
...
- `panel_date_update/update_panel_date.py` — 특정 panel 의 시작/종료일 일괄 치환
