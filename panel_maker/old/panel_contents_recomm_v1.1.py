# panel_contents_recomm_v1.1.py
# 2026-05-18  Jonghyun Park w/ Claude
# updated: 2026-05-19 22:55  — v1.1 신규 작성: R15 column 삽입
#
...
# ─── 대상 프로젝트 ──────────────────────────────────────────────────
TARGET_PROJECT_ID = "YOUR_TARGET_PROJECT_ID"  # your target project
...
R14_TO_R15 = {
    # ── Global ──
    ("global", "none"): {
        "r14_id": "YOUR_SEGMENT_ID",
        "r15_id": "",  # R15 no-suffix 없음 → skip
        "r15_name": "",
    },
    ("global", "visit"): {
        "r14_id": "YOUR_SEGMENT_ID",
        "r15_id": "YOUR_SEGMENT_ID",
