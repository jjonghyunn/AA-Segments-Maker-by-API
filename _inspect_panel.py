...
TAIL_SEG_IDS = [
    "segment_id_placeholder",  # CC_03 - 04. Running Ritual
    "segment_id_placeholder",  # CC_03 - 04. Running Ritual (Visit)
    "segment_id_placeholder",  # CC_03 - 04. Running Ritual (Delayed Purchase)
    "segment_id_placeholder",  # US_CC_03 - 04. Running Ritual
    "segment_id_placeholder",  # US_CC_03 - 04. Running Ritual (Visit)
    "segment_id_placeholder",  # US_CC_03 - 04. Running Ritual (Delayed Purchase)
]
